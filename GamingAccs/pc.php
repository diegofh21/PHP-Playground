...
<div class="container push-cont">
  ...
  <div class="containpc mb-5">
    ...
    <h3 class="text-center pt-4"><img src="utils/logo-categoria-pc.png" alt="" width=10%>Computadoras Gaming<img src="utils/logo-categoria-pc.png" alt="" width=10%></h2>
    <h6 class="text-center pt-2">En donde encontrarás el computadora de escritorio que tanto has soñado, gamer!</h4>
    <?php
    ...
    {?>
      <div class="contpc">
        ...
        <div class="titlepc">
          ...
          <a href="procesos/add-car.php?categoria=computadora&producto=<?php echo $columna[ 'id_prod' ]; ?>" class="boton boton-comprar">Agregar</a>
