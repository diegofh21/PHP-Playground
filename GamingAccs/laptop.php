...
<div class="container push-cont">
  ...
  <div class="containpc mb-5">
    <h3 class="text-center pt-4"> <img src="utils/logo-laptop.png" alt="" width=10%> Laptops Gaming <img src="utils/logo-laptop.png" alt="" width=10%></h2>
    <h6 class="text-center pt-2">¿Poder portatil? Lo tenemos justo aquí!</h4>
    <?php
    ...
    {?>
      <div class="contpc">
        ...
        <div class="titlepc">
          ...
          <a href="procesos/add-car.php?categoria=laptop&producto=<?php echo $columna[ 'id_prod' ]; ?>" class="boton boton-comprar">Agregar</a>
